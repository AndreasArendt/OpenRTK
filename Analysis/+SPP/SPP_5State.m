...
subplot(4,2,2);
hold on; grid on;
plot(station_pos__m(1) - pos_E__m(:,1), 'DisplayName', 'LSQ (5 States)')
legend('show')
...
subplot(4,2,4);
hold on; grid on;
plot(station_pos__m(2) - pos_E__m(:,2), 'DisplayName', 'LSQ (5 States)')
legend('show')
...
subplot(4,2,6);
hold on; grid on;
plot(station_pos__m(3) - pos_E__m(:,3), 'DisplayName', 'LSQ (5 States)')
legend('show')
