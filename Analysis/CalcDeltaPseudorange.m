function [delta_pseudorange] = CalcDeltaPseudorange(x_rx, y_rx, z_rx, Code_1, Code_2, F1, F2, dt_sv, cdt_rx, dt_rel, dx, dy, dz)
...
%   Detailed explanation goes here
    ...
    r_ionofree = CalcIonoFreeLinearCombination(Code_1, Code_2, F1, F2);
